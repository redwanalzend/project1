...
function First(){
    return(
        ...
        <div>
         <div style={{backgroundImage: "url(https://avada.theme-fusion.com/pet-supplies/wp-content/uploads/sites/139/2020/04/banner-14@2x-scaled.jpg)"}}
              className="wx-100% h-96 bg-center bg-cover" >
             <p className="font-bold text-white text-center pt-28 text-5xl ">Contact</p>
